...
# Function to fetch latest phone models (Mock API)
...
# Function to find the best response using TF-IDF similarity
...
# Function to process user input with Google Gemini AI
...
if st.button("Ask"):
    ...
    # Display response before chat history
